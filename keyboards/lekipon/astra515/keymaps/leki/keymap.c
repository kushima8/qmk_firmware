...
[_ANSI] = LAYOUT( /* Base ANSI */
 ...
 KC_LCTL, KC_A   , KC_O   , KC_E   , KC_U   , KC_I   , KC_MINS, KC_TILD, KC_EQL , KC_D   , KC_H   , KC_T   , KC_N   , KC_S   , KC_SLSH,\
...
[_JIS] = LAYOUT( /* JIS */
 ...
 _______, _______, _______, _______, _______, _______, JU_MINS, JU_GRV , JU_EQL , _______, _______, _______, _______, _______, _______,\
 ...
 /* RAISE
   ...
   * |-------+-------+-------+-------+-----------------------| _____ |-----------------------+-------+-------+-------+-------|
   * | _____ | CAPS  | _____ | _____ |   ADJUST  |  _______  |       |  _______  |  _______  | _____ | _____ | Insert| _____ |
   * `-----------------------------------------------------------------------------------------------------------------------'
   */
[_RAISE] = LAYOUT( /* RAISE */
 ...
 _______, KC_CAPS, _______, _______, ADJUST , XXXXXXX, _______, XXXXXXX, _______, XXXXXXX, _______, _______, _______, KC_INS , _______\
),
 ...
 /* LOWER
   ...
   * |-------+-------+-------+-------+-----------------------| _____ |-----------------------+-------+-------+-------+-------|
   * | _____ | CAPS  | _____ | _____ |  _______  |  _______  |       |  _______  |       0   |   00  |   .   | Insert| _____ |
   * `-----------------------------------------------------------------------------------------------------------------------'
   */
[_LOWER] = LAYOUT( /* LOWER */
 KC_GRV , KC_EXLM, KC_AT  , KC_HASH, KC_DLR , KC_PERC, KC_PSCR, KC_SLCK, KC_PAUS, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_INS ,\
 KC_TAB , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_P7  , KC_P8  , KC_P9  , KC_PMNS, _______,\
 ...
 _______, KC_CAPS, _______, _______, _______, XXXXXXX, _______, XXXXXXX, _______, XXXXXXX, KC_P0  , KC_P00 , KC_PDOT, KC_INS , _______
),
...
[_ADJUST] = LAYOUT( /* ADJUST (RAISE+LOWER)*/
 ...
 XXXXXXX, XXXXXXX, RGB_HUI, RGB_SAI, RGB_VAI, RGB_MOD, XXXXXXX, XXXXXXX, XXXXXXX, KC_NLCK, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,\
...
#define HSV_LOWER    85, 255,  96 //Green
#define HSV_RAISE    16, 255,  96 //Orange
