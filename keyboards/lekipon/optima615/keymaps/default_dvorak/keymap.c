...
[_ANSI] = LAYOUT_ortho_6x15( /* Base ANSI Mode */
 ...
 KC_TAB , KC_QUOT, KC_COMM, KC_DOT , KC_P   , KC_Y   , KC_BSPC, KC_F   , KC_G   , KC_C   , KC_R   , KC_L   , KC_SLSH, KC_EQL , KC_BSPC,\
 KC_LCTL, KC_A   , KC_O   , KC_E   , KC_U   , KC_I   ,          KC_D   , KC_H   , KC_T   , KC_N   , KC_S   , KC_MINS,          KC_DEL ,\
 KC_LSFT, KC_SCLN, KC_Q   , KC_J   , KC_K   , KC_X   , KC_ENT , KC_B   , KC_M   , KC_W   , KC_V   , KC_Z   , KC_BSLS, KC_RSFT, KC_INS ,\
...
/* JIS Mode(DVORAK)
   ...
   * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
   * | Tab   |  JU'  |   ,   |   .   |   P   |   Y   |  B/S  |   F   |   G   |   C   |   R   |   L   |   /   |  JU=  |  B/S  |
   * |-------+-------+-------+-------+-------+-------|       |-------+-------+-------+-------+-------+-------+-------+-------|
   * | Ctrl  |   A   |   O   |   E   |   U   |   I   |-------|   D   |   H   |   T   |   N   |   S   |  JU-  |       |  Del  |
   * |-------+-------+-------+-------+-------+-------|       |-------+-------+-------+-------+-------+-------|       |-------|
...
[_JIS] = LAYOUT_ortho_6x15( /* JIS Mode */
 ...
 _______, JU_QUOT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, JU_EQL , _______,\
 _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, JU_MINS,          _______,\
