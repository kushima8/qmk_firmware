...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 /* JIS Mode
   ...
   * `-------------------------------'　　　　　　　　　　　　　　　　          `-----------------------------------------------'
   */
[_JIS] = LAYOUT_ortho_6x15( /* Base JIS Mode */
 KC_ESC , KC_1   , JU_2   , KC_3   , KC_4   , KC_5   , JU_CAPS, JU_6   , JU_7   , JU_8   , JU_9   , JU_0   , JU_MINS, JU_EQL , ADJUST ,\
 KC_TAB , KC_Q   , KC_W   , KC_E   , KC_R   , KC_T   , KC_BSPC, KC_Y   , KC_U   , KC_I   , KC_O   , KC_P   , JU_LBRC, JU_RBRC, KC_BSPC,\
 KC_LCTL, KC_A   , KC_S   , KC_D   , KC_F   , KC_G   ,          KC_H   , KC_J   , KC_K   , KC_L   , JU_SCLN, JU_QUOT,          KC_DEL ,\
 KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_ENT , KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, JU_BSLS, KC_RSFT, KC_INS ,\
...
/* ANSI Mode
   ...
   * `-------------------------------'　　　　　　　　　　　　　　　　          `-----------------------------------------------'
   */
[_ANSI] = LAYOUT_ortho_6x15( /* ANSI Mode */
 _______, _______, KC_2   , _______, _______, _______, KC_CAPS, KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_MINS, KC_EQL , ADJUST ,\
 _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, _______,\
 _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, KC_SCLN, KC_QUOT,          _______,\
 _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_BSLS, _______, _______,\
...
#define HSV_JIS      85, 255,  16 //Green
#define HSV_ANSI    169, 255,  48 //Blue
