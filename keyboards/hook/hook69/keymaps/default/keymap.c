...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_3rd] = LAYOUT(
     // ,--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------.
        KC_ESC   ,JP_ZKHK ,KC_Q    ,KC_W    ,KC_E    ,KC_R    ,KC_T    ,KC_Y    ,KC_SPC  ,KC_U    ,KC_I    ,KC_O    ,KC_P    ,JP_AT   ,JP_LBRC ,KC_RGUI ,KC_BSPC ,KC_1    ,KC_2    ,KC_3    ,KC_0    ,JP_MINS ,JP_CIRC ,KC_C,
     // |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
        KC_TAB   ,KC_LSFT ,KC_A    ,KC_S    ,KC_D    ,KC_F    ,KC_G    ,KC_H    ,KC_SPC  ,KC_J    ,KC_K    ,KC_L    ,JP_SCLN ,JP_COLN ,JP_RBRC ,KC_RSFT ,KC_ENT  ,KC_4    ,KC_5    ,KC_6    ,KC_PSCR ,KC_UP   ,JP_YEN  ,
     // |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
        KC_CAPS  ,KC_LCTL ,KC_LALT ,KC_Z    ,KC_X    ,KC_C    ,KC_V    ,KC_B    ,KC_SPC  ,KC_N    ,KC_M    ,KC_COMM ,KC_DOT  ,KC_SLSH ,JP_BSLS ,MO(_2nd),KC_RCTL ,KC_7    ,KC_8    ,KC_9    ,KC_LEFT ,KC_DOWN ,KC_RIGHT
    ...
    [_4th] = LAYOUT(
     // ,--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------.
        KC_ESC   ,JP_ZKHK ,KC_Q    ,KC_W    ,KC_E    ,KC_R    ,KC_T    ,KC_Y    ,KC_SPC  ,KC_U    ,KC_I    ,KC_O    ,KC_P    ,JP_AT   ,JP_LBRC ,KC_RGUI ,KC_BSPC ,KC_1    ,KC_2    ,KC_3    ,KC_0    ,JP_MINS ,JP_CIRC ,KC_D,
     // |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
        KC_TAB   ,KC_LSFT ,KC_A    ,KC_S    ,KC_D    ,KC_F    ,KC_G    ,KC_H    ,KC_SPC  ,KC_J    ,KC_K    ,KC_L    ,JP_SCLN ,JP_COLN ,JP_RBRC ,KC_RSFT ,KC_ENT  ,KC_4    ,KC_5    ,KC_6    ,KC_PSCR ,KC_UP   ,JP_YEN  ,
     // |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
        KC_CAPS  ,KC_LCTL ,KC_LALT ,KC_Z    ,KC_X    ,KC_C    ,KC_V    ,KC_B    ,KC_SPC  ,KC_N    ,KC_M    ,KC_COMM ,KC_DOT  ,KC_SLSH ,JP_BSLS ,MO(_2nd),KC_RCTL ,KC_7    ,KC_8    ,KC_9    ,KC_LEFT ,KC_DOWN ,KC_RIGHT
