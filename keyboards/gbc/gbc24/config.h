...
// If your PC does not recognize GBC, try setting this macro. This macro
...
#define SPLIT_TRANSACTION_IDS_KB GBC_GET_INFO, GBC_GET_MOTION, GBC_SET_CPI

#ifndef OLED_FONT_H
#    define OLED_FONT_H "keyboards/gbc/lib/logofont/logofont.c"
